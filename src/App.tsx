...
const MODULE_ACCESS:Record<string,string[]>={dashboard:['super_admin','regional_partner','sales_partner','company_admin','operator'],network_centrals:['super_admin','regional_partner','sales_partner'],partners_network:['super_admin','regional_partner'],commissions_network:['super_admin','regional_partner','sales_partner'],plans_network:['super_admin','regional_partner','sales_partner'],network_support:['super_admin','regional_partner','sales_partner'],payments:['super_admin'],live_map:['super_admin'],trips:['company_admin','operator'],drivers:['company_admin','operator'],vehicles:['company_admin'],clients:['company_admin','operator'],operators:['company_admin'],companies:['super_admin'],users:['super_admin'],reports:['company_admin'],history:['super_admin','company_admin'],settings:['super_admin','company_admin'],profile:['super_admin','regional_partner','sales_partner','company_admin','operator'],help:['super_admin','regional_partner','sales_partner','company_admin','operator']};
