...
import {Header} from './components/Header';import {Sidebar} from './components/Sidebar';import {DriverMobileShell} from './components/pwa/DriverMobileShell';import {DriverToCentralRadioPanel} from './components/pwa/DriverToCentralRadioPanel';import {CentralRadioReceiver} from './components/radio/CentralRadioReceiver';import {OperatorRadioLauncher} from './components/radio/OperatorRadioLauncher';
...
const SuperAdminOperationMap=lazy(()=>import('./components/map/SuperAdminOperationMap').then(module=>({default:module.SuperAdminOperationMap})));
...
const MODULE_ACCESS:Record<string,string[]>={dashboard:['super_admin','regional_partner','sales_partner','company_admin','operator'],network_centrals:['super_admin','regional_partner','sales_partner'],partners_network:['super_admin','regional_partner'],commissions_network:['super_admin','regional_partner','sales_partner'],plans_network:['super_admin','regional_partner','sales_partner'],network_support:['super_admin','regional_partner','sales_partner'],payments:['super_admin'],live_map:['super_admin'],trips:['company_admin','operator'],reservations:['company_admin','operator'],tariff:['company_admin','operator'],drivers:['company_admin','operator'],vehicles:['company_admin'],clients:['company_admin','operator'],operators:['company_admin'],companies:['super_admin'],users:['super_admin'],reports:['company_admin'],history:['super_admin','company_admin'],settings:['super_admin','company_admin','operator'],profile:['super_admin','regional_partner','sales_partner','company_admin','operator'],help:['super_admin','regional_partner','sales_partner','company_admin','operator']};
...
const MainAppContent:React.FC=()=>{
 const{currentRole,currentCompany,activeModule,setActiveModule,newTripModalOpen,setNewTripModalOpen,selectedTripForDetail,setSelectedTripForDetail,vhfModalDriver,setVHFModalDriver}=useApp();
