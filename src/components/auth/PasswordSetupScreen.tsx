    ...
    <main className="min-h-screen bg-[#070709] p-4 text-zinc-100 flex items-center justify-center">
      <section className="w-full max-w-md rounded-3xl border border-zinc-800 bg-[#0d0d0f] p-6 sm:p-8 shadow-2xl">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-amber-400/60 bg-zinc-950 text-amber-300"><ShieldCheck className="h-6 w-6" /></div>
          <div><p className="text-[9px] font-black uppercase tracking-widest text-amber-300">Central GO · Cuenta oficial</p><h1 className="text-xl font-black text-white">{recovery ? 'Crea una nueva contraseña' : 'Activa tu acceso'}</h1></div>
        </div>
