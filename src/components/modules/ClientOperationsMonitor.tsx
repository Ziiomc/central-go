...
import{SuperAdminOperationMap}from'../map/SuperAdminOperationMap';
...
export const ClientOperationsMonitor:React.FC<ClientOperationsMonitorProps>=({onBack})=>{
 ...
 return <div className="space-y-5">
  ...
  {loading?<div className="flex min-h-56 items-center justify-center gap-2 rounded-2xl border border-zinc-800 bg-[#0d0d0f] text-xs font-bold text-zinc-400"><Loader2 className="h-5 w-5 animate-spin text-blue-400"/>Leyendo operación real…</div>:<>
   ...
   <SuperAdminOperationMap companyId={companyId} companyName={currentCompany.name} height="h-[460px]"/>
