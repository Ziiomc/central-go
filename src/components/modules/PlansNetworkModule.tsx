  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.18em] text-blue-300 mb-2">
            <Layers3 className="w-3.5 h-3.5" /> Oferta comercial oficial
          </div>
          <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight">Planes y valores Central GO</h1>
          <p className="text-xs text-zinc-400 mt-1">Los valores y capacidades se leen directamente desde Supabase; no son cifras de demostración.</p>
        </div>
      ...
      <PlanComparison
        ...
        title={partnerView ? 'Tabla de valores para presentar al cliente' : 'Catálogo comercial y capacidades'}
