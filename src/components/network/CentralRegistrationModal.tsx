...
export const CentralRegistrationModal: React.FC<CentralRegistrationModalProps> = ({ open, onClose, onCreate }) => {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md">
      <div className="w-full max-w-4xl overflow-hidden rounded-3xl border border-zinc-700 bg-[#0d0d0f] shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-zinc-800 bg-gradient-to-r from-purple-950/30 via-[#0d0d0f] to-blue-950/20 p-5 sm:p-6">
