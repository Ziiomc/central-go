...
const clearPendingAgeStyle=(node:HTMLElement)=>{node.style.removeProperty('background');node.style.removeProperty('background-color');node.style.removeProperty('box-shadow');node.style.removeProperty('border-color');node.removeAttribute(AGE_MARK);};
