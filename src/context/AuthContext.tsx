...
export interface SaaSAccount { accountKind:'central'|'driver'|'sales_partner'; companyId:string|null; status:string; trialStartedAt:string; trialEndsAt:string; currentPeriodEnd:string|null; countryCode:string|null; region:string|null; city:string|null; }
export type OnboardingRole='central'|'driver'|'sales_partner';
